      ...
      <aside>
         ...
         <div class="sidebar">
            ...
            if ($_SESSION['tipo'] == "admin" || $_SESSION['funcion'] == "funcionario") {
               ...
               echo '<a href="dashlotes.php" class="active">';
      ...
      <main>
         ...
         <div class="recent_order">
            ...
            if (isset($_POST['enviar_actualizar'])) {
               $id_lote_actualizar = $_POST['id_lote_actualizar'];
               $nombre_actualizado = $_POST['nombre'];
               $almacen_actualizado = $_POST['almacen'];
               $estado_actualizado = $_POST['estado'];
               $data = array('id_lote' => $id_lote_actualizar, 'nombre' => $nombre_actualizado, 'almacen' => $almacen_actualizado, 'estado' => $estado_actualizado);
               $json_data = json_encode($data);
               file_put_contents('./JSON/updtlotes.json', $json_data);
               include './assets/updtlotes.php';
            }

            include './vista/lotes.php';
            ?>
         </div>
