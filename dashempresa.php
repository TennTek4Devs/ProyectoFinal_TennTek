      ...
      <aside>
         ...
         <div class="sidebar">
            ...
            if ($_SESSION['tipo'] == "admin") {
               ...
               echo '<a href="dashempresa.php" class="active">';
      ...
      <main>
         ...
         <div class="recent_order">
            ...
            if (isset($_POST['enviar_actualizar'])) {
               $id_actualizado = $_POST['id_actualizado'];
               $usuario = $_POST['useract'];
               $nombre = $_POST['nombreact'];
               $rut = $_POST['rutact'];
               $correo = $_POST['emailact'];
               ...
               $json_data = json_encode($actualUsuario);
               file_put_contents('./JSON/updtempresa.json', $json_data);
               include './assets/updtempresa.php';
            }

            include 'vista/usuario_emp.php';
