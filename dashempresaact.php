      ...
      <main>
         ...
         <div class="recent_order">
            ...
            if (isset($_POST["actualizar_empresa"])) {
               ...
               $data = array('actualizar_empresa' => $actualizar_empresa);
               $json_data2 = json_encode($data);
               print_r($json_data2);
               file_put_contents('./JSON/updtempresa.json', $json_data2);

               // Cerrar la conexión
               $conn->close();
               header('Location: ./dashempresaact.php');
            }

            include 'vista/updusuario_emp.php';
