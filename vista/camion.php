<form class="form-almacen" method="POST" action="">
    ...
    <input type="number" name="capacidad" id="capacidad" min="5000" max="15000" required><br><br>
    ...
    <input class="enviar" type="submit" name="enviar_camion" value="Enviar">
</form>

<?php
if (isset($_POST['enviar_camion'])) {
    ...
    $consulta = "INSERT INTO camion (matricula, estado, capacidad, marca, modelo) VALUES ('$matricula', '$estado', $capacidad, '$marca', '$modelo')";
    $conn->query($consulta);
    $conn->close();
}
?>
        ...
        <tr>
            ...
            <td>
                <form method="POST" action="">
                    ...
                    <input type="submit" name="eliminar_camion" value="Eliminar">
                </form>
            </td>
        </tr>
    <?php endwhile; ?>
