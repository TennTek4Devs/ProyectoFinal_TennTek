   ...
   <div class="container">
      ...
      <main>
         ...
         <div class="recent_order">
            <h2>Actualizar Lotes</h2>
            <?php
            if (isset($_POST["actualizar_lote"])) {
               // Conectar a la base de datos
               include './assets/conexion.php';

               $actualizar_lote = $_POST['actualizar_lote'];

               $data = array('actualizar_lote' => $actualizar_lote);
