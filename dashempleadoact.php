   ...
   <div class="container">
      <aside>
         ...
         <div class="sidebar">
            ...
            if ($_SESSION['tipo'] == "admin") {
               // Mostrar el contenido para "admin"
               echo '<a href="dashempleado.php" class="active">';
      ...
      <main>
         ...
         <div class="recent_order">
            ...
            if (isset($_POST["actualizar_empleado"])) {
               ...
               $actualizar_empresa = $_POST['actualizar_empleado'];
             
               $data = array('actualizar_empleado' => $actualizar_empresa);
               $json_data2 = json_encode($data);
               file_put_contents('./JSON/updtempleado.json', $json_data2);
             
               // Cerrar la conexión
               $conn->close();
               header('Location: ./dashempleadoact.php');
             }

            
            include './vista/updusuario_emple.php';
            ?>
         </div>
