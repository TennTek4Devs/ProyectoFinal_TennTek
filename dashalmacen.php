...
<head>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css"
      integrity="sha512-+J+gkZn2KvLJz7zv6X8l+0zv9wJQjz5vz1zJfVQzZ9x7LHqy3jYvzL5yRzK4v3BfJZmXv4j5tZ5hCQ9JZ7z9Kg=="
   ...
   <div class="container">
      <aside>
         ...
         <div class="sidebar">
            ...
            if ($_SESSION['tipo'] == "admin" || $_SESSION['funcion'] == "funcionario") {
               // Mostrar el contenido para "admin" y $_SESSION['funcionario']
               echo '<a href="dashalmacen.php" class="active">';
      ...
      <main>
         ...
         <div class="recent_order">
            ...
            if (isset($_POST['enviar_actualizar'])) {
               $id_almacen_actualizar = $_POST['id_almacen'];
               $nombre_actualizado = $_POST['nombre'];
               $direccion_actualizada = $_POST['direccion'];
               $ciudad_actualizada = $_POST['ciudad'];
               $data = array('id_almacen' => $id_almacen_actualizar, 'nombre' => $nombre_actualizado, 'direccion' => $direccion_actualizada, 'ciudad' => $ciudad_actualizada);
               $json_data = json_encode($data);
               file_put_contents('./JSON/updtalmacenes.json', $json_data);
               include './assets/updtalmacenes.php';
               echo "<meta http-equiv='refresh' content='0'>";
            }

            include 'vista/almacen.php';
            ?>
         </div>
