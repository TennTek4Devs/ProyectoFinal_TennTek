...
<?php
      ...
      <main>
         ...
         <div class="recent_order">
            <h2>Paquetes</h2>
            <?php
            // Si se envía el formulario, actualizar el archivo JSON de ./JSON/updtpaquete.json
            if (isset($_POST["enviar_actualizacion"])) {
               ...
               // Crear un arreglo asociativo con los datos actualizados
               $actualizar_paquete = array(
               ...
               $actualizar_paquete_json = json_encode($actualizar_paquete);

               // Escribir el JSON en el archivo ./JSON/updtpaquete.json
               file_put_contents("./JSON/updtpaquetes.json", $actualizar_paquete_json);

               // Incluir el archivo ./assets/updtpaquete.php
               include "./assets/updtpaquete.php";
               include './assets/paquete.php';
            }

            include './vista/paquetes.php';
            ?>
         </div>
